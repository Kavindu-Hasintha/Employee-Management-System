...
export class Employee extends Component {
  ...
  refreshList() {
    fetch(variables.API_URL + "employee/GetEmpDetails")
              ...
              <tr key={emp.eid}>
                ...
                <td>
                  ...
                  <button
                    type="button"
                    className="btn btn-light mr-1"
                    onClick={() => this.deleteClick(emp.eid)}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                  ...
                  <div className="p-2 w-50 bd-highlight">
                    ...
                    <div className="input-group mb-3">
                      ...
                      <select
                        ...
                        onChange={this.changeDeptname}
                        value={deptname}
                      >
                        {departments.map((dep) => (
                          <option key={dep.did}>{dep.dname}</option>
                        ))}
                      </select>
                    </div>
